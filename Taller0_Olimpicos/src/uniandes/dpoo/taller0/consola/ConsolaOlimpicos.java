...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar país que representa un atleta en específico");
	...
	/**
	 * Ejecuta la opción para consultar el país del atleta en cuestión.
	 */
	private void ejecutarPaisAtleta()
	{
		...
		try
		{
			...
			String nombre_atleta = input("Ingrese el nombre del atleta que desea consultar");
			String rta = calculadora.paisAtleta(nombre_atleta);
			if (rta == null)
			{
				System.out.println("\nNo se encontró un atleta llamado " + nombre_atleta);
			}
			else
			{
				System.out.println("\nEl atleta " + nombre_atleta + " representa a " + rta );
			}
		}
		catch (Exception e)
		{
			System.out.println("\nNo es un atleta válido");
		}
	}
